...
namespace pj_Pharmacy.MrControlers
{
    ...
    internal class MrComboBox : UserControl
    {
        ...
        [Browsable(false)] // Para que no aparezca en la ventana de propiedades del diseñador
        ...
        private void InitializeComponent()
        {
            ...
            // MrComboBox
            // 
            this.Name = "MrComboBox";
            this.Load += new System.EventHandler(this.MrComboBox_Load);
            this.ResumeLayout(false);

        }

        private void MrComboBox_Load(object sender, EventArgs e)
        {
